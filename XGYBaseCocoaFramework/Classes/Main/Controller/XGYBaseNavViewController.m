...
@interface XGYBaseNavViewController ()<UIGestureRecognizerDelegate>

@end

@implementation XGYBaseNavViewController
/**
 *  当导航控制器的view创建完毕就调用
 */
- (void)viewDidLoad
...
+ (void)setupNavigationBarTheme
{
    ...
    textAttrs[NSFontAttributeName] = XGYNavigationTitleFont;
