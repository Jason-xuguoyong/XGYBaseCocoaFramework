...
// 颜色
#define XGYColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1]

// 随机色
#define XGYRandomColor XGYColor(arc4random_uniform(256), arc4random_uniform(256), arc4random_uniform(256))
